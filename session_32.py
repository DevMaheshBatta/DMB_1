...
db = client['GWPDS']  # Database name
patients_collection = db['consultations']  # Collection for patient data

# Home route
@app.route('/')
def home():
    return "Doctor Consultation System with ML"
...
# Sample dataset (in practice, this would be loaded from MongoDB or a file)
data = {
    'fever': [98.6, 101.2, 102.4, 99.0, 100.1],
    'cough': [0, 1, 1, 0, 1],
    'fatigue': [0, 1, 1, 0, 0],
    'headache': [0, 1, 0, 0, 1],
    'diagnosis': [0, 1, 1, 0, 1]  # 0: Healthy, 1: Flu
}
