...
@web_app.route("/add-users",methods=["POST"])
def add_user_in_db():
    #create dictionary with data from HTML register form
    user_data= {
    ...
    # message="welcome to home page :{name},{email},{Password}".format(result.inserted_id)
    # return message
